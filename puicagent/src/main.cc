...
int main(int argc, char **argv)
{
    ...
    if (help->count > 0)
    {
        ...
        printf("Agent for puic protocol.\n\n");
    ...
    exitcode = multi_proxy_main(argv[0], listen->sval, listen->count, output->sval[0], forward->sval[0]);
